module Tmuxinator
  class Cli < Thor
    ...
    def start(name, custom_name = nil)
      project = create_project(name: name, custom_name: custom_name, attach: options[:attach])
    ...
    def debug(name, custom_name  = nil)
      ...
      project = create_project(name: name, custom_name: custom_name, attach: options[:attach])
      # project = create_project(name: name, custom_name: custom_name, **symbolized_options)
      puts project.render
    end
